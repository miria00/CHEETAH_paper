...
(\texttt{systems/feasibility\_checks.py} and the LP builders\footnote{The builder files keep their historical \texttt{deepseek\_socp\_*} names; the exported program is a pure LP.}).}
...
\bottomrule
\end{tabular}
\caption{Silicon cost model: area and power coefficients. Sources: \texttt{feasibility\_checks.py} lines 32--48 and the LP builders (\texttt{deepseek\_socp\_codesign.py} lines 341--350, \texttt{deepseek\_socp\_serving\_codesign.py} lines 147--152).}
